...
class HogeScene {
    constructor(pScene) {
        ...
        pScene.backgroundColor = '#ccccc0';
        {
            ...
            this.centerRect = Rect((this.screenRect.width - minSize) * 0.5, (this.screenRect.height - minSize) * 0.5, minSize, minSize);
        }
        {
            const label = Label({
                text: 'hoge',
